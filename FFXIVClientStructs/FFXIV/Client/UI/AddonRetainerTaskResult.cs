...
public unsafe partial struct AddonRetainerTaskResult {
    ...
    [FieldOffset(0x220)] public AtkTextNode* VentureNameText;
    [FieldOffset(0x228)] public AtkComponentBase* EXPAwardContainer;
    [FieldOffset(0x230)] public AtkResNode* ItemRewardContainer;
    [FieldOffset(0x238)] public AtkTextNode* CompletionDateText;
    [FieldOffset(0x240)] public AtkComponentButton* ReassignButton;
    [FieldOffset(0x248)] public AtkComponentButton* ConfirmButton;
    // [FieldOffset(0x250)] public nint Unk_250;
